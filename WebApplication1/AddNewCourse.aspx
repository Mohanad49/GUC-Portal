   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred; color: white;"><h3 style="text-align:center">
        ...
        <div>
            <label for="major" style="color: white;">Major:</label>
            ...
            <label for="creditHours" style="color: white;">Credit Hours:</label>
            ...
            <label for="isOffered" style="color: white;">Is Offered:</label>
            <asp:DropDownList ID="ddlIsOffered" runat="server" required>
                <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                <asp:ListItem Text="No" Value="0"></asp:ListItem>
            </asp:DropDownList><br>

            <asp:Button ID="btnAddCourse" runat="server" Text="Add Course" style="color: white;" OnClick="btnAddCourse_Click" />
        </div>
