<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addPhoneNo.aspx.cs" Inherits="Admin.addPhoneNo" %>
...
<div class="content">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Send</span>
    ...
    <asp:TextBox ID="phoneNo" runat="server" CssClass="input-style"></asp:TextBox>
     <asp:Literal ID="Literal1" runat="server"></asp:Literal>
      <asp:Button ID="Button1" runat="server" Text="Add" OnClick="Button1_Click" CssClass="submit-style"  />
