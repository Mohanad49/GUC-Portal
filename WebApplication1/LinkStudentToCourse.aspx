 ...
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred;color:white;"><h3 style="text-align:center">
            Link Student To Course </h3> 
           <div>
            <asp:Label ID="lblResult" runat="server" ForeColor="Green" style="color: lawngreen;" EnableViewState="False"></asp:Label>
        </div>
        <div>
            <asp:Label ID="lblError" runat="server" ForeColor="Red" style="color: red;" EnableViewState="False"></asp:Label>
        </div>
        <div>
            <label for="courseId" style="color: white;">Course ID:</label>
            <asp:TextBox ID="txtCourseId" runat="server" type="number" required></asp:TextBox><br>

            <label for="instructorId" style="color: white;">Instructor ID:</label>
            ...
            <label for="semesterCode" style="color: white;">Semester Code:</label>
            <asp:TextBox ID="txtSemesterCode" runat="server" required></asp:TextBox><br>

            <asp:Button ID="btnLinkStudentToCourse" runat="server" Text="Link Student to Course" style="color: white;" OnClick="btnLinkStudentToCourse_Click" />
        </div>
