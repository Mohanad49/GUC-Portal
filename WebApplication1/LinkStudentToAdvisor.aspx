    ...
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred; color: white;"><h3 style="text-align:center">
        ...
        <div>
            ...
            <label for="advisorId" style="color: white;">Advisor ID:</label>
            <asp:TextBox ID="txtAdvisorId" runat="server" type="number" required></asp:TextBox><br>

            <asp:Button ID="btnLinkStudentToAdvisor" runat="server" Text="Link Student to Advisor" style="color: white;" OnClick="btnLinkStudentToAdvisor_Click" />
        </div>
