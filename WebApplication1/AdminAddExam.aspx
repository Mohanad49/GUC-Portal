...
<div class="content">
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <div class="user-box" style="top:350px;left:50%;background-color:darkred; color: white;">
    <h2>Add Exam</h2>
<div>
    ...
    <label for="txtType" style="color: white;">Exam Type:</label>
    <asp:TextBox ID="txtType" runat="server" ClientIDMode="Static" CssClass="txtType" required></asp:TextBox><br>

    <label for="txtDate" style="color: white;">Start Date:</label>
    ...
    <label for="txtCourseID" style="color: white;">Course ID:</label>
