<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="optionalCourses.aspx.cs" Inherits="Admin.optionalCourses" %>
...
<div class="content">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Send</span>
    ...
    <asp:TextBox ID="userID" runat="server" CssClass="input-style"></asp:TextBox>--%>
        <div class="info-bar">
       Enter Current Semester Code
    </div>
    <asp:TextBox ID="semes" runat="server" CssClass="input-style"></asp:TextBox>
      <asp:Literal ID="Literal1" runat="server"></asp:Literal>
      <asp:Button ID="Button1" runat="server" Text="Show" OnClick="Button1_Click" CssClass="submit-style"  />
