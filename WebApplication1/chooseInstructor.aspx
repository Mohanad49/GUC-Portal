<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chooseInstructor.aspx.cs" Inherits="Admin.chooseInstructor" %>
...
<div class="content">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Send</span>
    <div class="buttons">
     ...
     <div class="user-box" style="top:380px;left:54%; text-align:center;height:auto;width:auto; background-color:#E0B0FF;">            <div class="info-bar">
               Enter A Course ID
            </div>
            <asp:TextBox ID="cid" runat="server" CssClass="input-style"></asp:TextBox>
            <asp:Literal ID="Literal1" runat="server"></asp:Literal>

            <div class="info-bar">
                Enter A Instructor ID
            </div>
            <asp:TextBox ID="typ" runat="server" CssClass="input-style"></asp:TextBox>
            <asp:Literal ID="Literal2" runat="server"></asp:Literal>

            <div class="info-bar">
                 Enter A semester code
            </div>
            <asp:TextBox ID="sc" runat="server" CssClass="input-style"></asp:TextBox>
            <asp:Literal ID="Literal3" runat="server"></asp:Literal>

<asp:Button ID="Button1" runat="server" Text="Send Request" OnClick="Button1_Click" CssClass="submit-style"  />
