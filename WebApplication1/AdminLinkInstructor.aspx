    ...
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred; color: white;"><h3 style="text-align:center">
        ...
        <div>
            ...
            <label for="slotId" style="color: white;">Slot ID:</label>
            <asp:TextBox ID="txtSlotId" runat="server" type="number" required></asp:TextBox><br>

            <asp:Button ID="btnLinkInstructor" runat="server" Text="Link Instructor" style="color: white;" OnClick="btnLinkInstructor_Click" />
        </div>
