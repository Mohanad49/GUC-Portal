...
<div class="content">
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <h2>Delete Course</h2>
    <div>
        <asp:Label ID="lblResult" runat="server" CssClass="message success" style="color: lawngreen;"></asp:Label>
    </div>
    <div>
        <asp:Label ID="lblError" runat="server" CssClass="message error" style="color: red;"></asp:Label>
    </div>
    <div>
        ...
        <asp:Button ID="btnDelete" runat="server" Text="Delete Course" style="color: white;" OnClick="btnDelete_Click" />
    </div>
</div>
    </div>
        <script>
