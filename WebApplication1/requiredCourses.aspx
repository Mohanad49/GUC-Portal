<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="requiredCourses.aspx.cs" Inherits="Admin.requiredCourses" %>
            ...
            <div class="dropdown" onclick="toggleDropdown(this)">
               <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">View</span>
                <div class="buttons">
                    ...
                    <a href="coursesAndpreq.aspx" class="button">Courses And In</a>
                </div>
            </div>
