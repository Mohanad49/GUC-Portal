<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slotsOfInstructor.aspx.cs" Inherits="Admin.slotsOfInstructor" %>
...
<div class="content">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Send</span>
    <div class="buttons">
     ...
     <div class="user-box" style="top:380px;left:54%; text-align:center;height:auto;width:auto; background-color:#E0B0FF;">
                     <div class="info-bar">
               Enter A Course ID
            </div>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="True">
       ...
       <script>
           ...
           function hideDropdown(buttons) {
               ...
               }, 1000000); // Adjust the delay as needed (200 milliseconds in this example)
           }
