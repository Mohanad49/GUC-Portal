<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="creditHourRequest.aspx.cs" Inherits="Admin.creditHourRequest" %>
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Send</span>
    <div class="buttons">
     ...
     <div class="user-box" style="top:380px;left:54%; text-align:center;height:auto;width:auto; background-color:#E0B0FF;">
            <div class="info-bar">
               Enter A Credit Hours
            </div>
            <asp:TextBox ID="crditH" runat="server" CssClass="input-style"></asp:TextBox>
            ...
            <asp:TextBox ID="comm" runat="server" CssClass="input-style"></asp:TextBox>
