...
namespace Admin
{
    public partial class coursesAndpreq : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!IsPostBack)
                {
                    ...
                    if (Session["UserId"] != null)
                    {
                        ...
                        BindCoursesAndExamsData(storedUserId);
                    }
                    else
                    {
        ...
        private void BindCoursesAndExamsData(int storedUserId)
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT * FROM view_Course_prerequisites", conn))
                    {
