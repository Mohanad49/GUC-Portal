...
( 'John', 'Doe', 3.5, 'Engineering', 'john.doe@example.com', 'CS', 'password123', 1, 1, 170, 30, 1),
...
INSERT INTO Payment (payment_id,amount, deadline, n_installments, status, fund_percentage, startdate, student_id, semester_code)
VALUES
(1,500, '2023-12-22', 1, 'notPaid', 50.00, '2023-11-22', 1, 'W23'),
(2,700, '2023-12-23', 1, 'notPaid', 60.00, '2023-11-23', 2, 'S23'),
(3,600, '2024-03-24', 4, 'notPaid', 40.00, '2023-11-24', 3, 'S23R1'),
(4,800, '2023-12-25', 1, 'notPaid', 70.00, '2023-11-25', 4, 'S23R2'),
(5,550, '2024-04-26', 5, 'notPaid', 45.00, '2023-11-26', 5, 'W23'),
(6,900, '2023-12-27', 1, 'notPaid', 80.00, '2023-11-27', 6, 'W24'),
(7,750, '2023-12-28', 2, 'Paid', 65.00, '2023-10-28', 7, 'S24'),
(8,620, '2023-12-29', 4, 'Paid', 55.00, '2023-08-29', 8, 'S24R1'),
(9,720, '2024-01-30', 2, 'notPaid', 75.00, '2023-11-30', 9, 'S24R2'),
(10,580, '2023-12-31', 1, 'Paid', 47.00, '2023-11-30', 10, 'S24');


-- Adding 10 records to the Installment table
INSERT INTO Installment (payment_id, deadline, amount, status, startdate)
VALUES
(1, '2023-12-22', 50, 'notPaid', '2023-11-22'),
(2, '2023-12-23', 70, 'notPaid', '2023-11-23'),
(3, '2024-01-24', 60, 'notPaid', '2023-12-24'),
(4, '2023-12-25', 80, 'notPaid', '2023-11-25'),
(5, '2024-03-26', 55, 'notPaid', '2024-2-26'),
(6, '2023-12-06', 90, 'notPaid', '2023-11-27'),
(7, '2023-11-28', 75, 'Paid', '2023-10-28'),
(7, '2023-12-28', 62, 'Paid', '2023-11-28'),
(9, '2024-01-30', 72, 'notPaid', '2023-12-30'),
(10, '2023-12-30', 58, 'Paid', '2023-11-30');
SELECT * FROM Course